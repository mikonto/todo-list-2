...
class UI {
  static loadHomepage() {
    UI.displayMainBody("todoListId", _todoList__WEBPACK_IMPORTED_MODULE_0__["default"].instances[0].id, false);
    UI.initTodoAdd();
    UI.initButtons();
  }
  ...
  static initStaticNav() {
    ...
    inbox.addEventListener("click", () => {
      UI.displayMainHeader(_todoList__WEBPACK_IMPORTED_MODULE_0__["default"].instances[0].id);
      UI.displayMainBody("todoListId", _todoList__WEBPACK_IMPORTED_MODULE_0__["default"].instances[0].id, false);
      UI.initTodoAdd();
    });
    ...
    today.addEventListener("click", () => {
      ...
      const todayDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(), "yyyy-MM-dd").toString();
  ...
  static initDynamicNav() {
    ...
    todoLists.forEach((todoList) => {
      ...
      listDelete.addEventListener("click", () => {
        _todo__WEBPACK_IMPORTED_MODULE_1__["default"].removeMultipleInstances("todoListId", todoList.id);
  ...
  static displayMainHeader(todoListId) {
    ...
    if (
      ...
      const todoList = _todoList__WEBPACK_IMPORTED_MODULE_0__["default"].instances.find(
  ...
  static displayMainBody(todoKey, todoValue, finished) {
    ...
    const todos = _todo__WEBPACK_IMPORTED_MODULE_1__["default"].instances.filter(
      (instance) =>
    ...
    if (todos.length === 0) {
      ...
      todos.forEach((todo) => {
        ...
        checkboxButton.addEventListener("click", () => {
          ...
          setTimeout(() => {
            if (todo.finished === false) {
              _todo__WEBPACK_IMPORTED_MODULE_1__["default"].changeFinished(todo, true);
            } else if (todo.finished === true) {
              _todo__WEBPACK_IMPORTED_MODULE_1__["default"].changeFinished(todo, false);
            }
        ...
        dueDiv.innerText = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(todo.dueDate), "dd/MM/yyyy");
        ...
        deleteButton.addEventListener("click", () => {
          _todo__WEBPACK_IMPORTED_MODULE_1__["default"].removeSingleInstance(todo);
          UI.displayMainBody(todoKey, todoValue, false);
        });
  ...
  static addTodoListFromModal() {
    ...
    if (value !== "") {
      ...
      UI.initDynamicNav();
      UI.makeTodoListNavActive(_todoList__WEBPACK_IMPORTED_MODULE_0__["default"].instances.length + 2);
...
document.addEventListener(
  "DOMContentLoaded",
  _modules_todoList__WEBPACK_IMPORTED_MODULE_1__["default"].checkTodoListLocalStorage()
);
document.addEventListener("DOMContentLoaded", _modules_todo__WEBPACK_IMPORTED_MODULE_2__["default"].checkTodoLocalStorage);
